...
classes = ['datafiles/images/class_null.png']
...
tracks = ['Adelaide', 'Adelaide Historic 1988', 'Azure Circuit', 'Barcelona GP (no chicane)', 'Barcelona GP', 'Barcelona GP National', 'Bathurst 2020', 'Brands Hatch', 'Brands Hatch Indy', 'Brasilia Full',
          ...
          'Hockeinheim Short B', 'Hockeinheim Historic 2001', 'Hockeinheim Historic 1988', 'Hockeinheim Historic 1988 (short)', 'Hockeinheim Historic 1977', 'Ibarra Yahuarcocha', 'Ibarra Yahuarcocha Reverse',
          'Imola', 'Imola Historic 2001', 'Imola Historic 1988', 'Imola Historic 1972', 'Indianapolis Road Course', 'Indianapolis Oval', 'Interlagos GP', 'Interlagos Historic 1976',
          ...
          'Spielberg Historic 1977', 'Taruma International', 'Taruma Chicane', 'Termas de Rio Hondo', 'Velo Citta', 'Velo Citta Track Day', 'Velo Citta Club Day', 'Velo park 2017', 'Velopark 2010',
          'VIRginia International Full', 'VIRginia International Grand', 'VIRginia International North', 'VIRginia International Patriot', 'Watkins Glen GP', 'Watkins Glen GP (inner loop)', 'Watkins Glen short',
